...
export default function WhyOfferPrivateGpAccess() {
  return (
    <>
      <section className="relative isolate overflow-hidden bg-cream">
        <Image
          src="/images/_business-subpages/Screenshot 2026-07-25 190912 1 (1).png"
          alt=""
          aria-hidden
          fill
          priority
        ...
        <div className="space-y-10">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-sm leading-relaxed text-pretty text-brand-teal/70">
              Private GP access gives employees a simple way to speak with a GP by phone or video when they need advice, without adding another complicated process to their day.
            </p>
            <p className="mt-5 max-w-2xl text-sm leading-relaxed text-pretty text-brand-teal/70">
              It can support employees with everyday symptoms, family health questions, and decisions about whether to use NHS 111, their NHS GP, or another service.
            </p>
          </div>
