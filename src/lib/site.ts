...
export const plans = [
  ...
  },
  {
    ...
    covers:
      "Includes full family package: you, your partner & dependent children covered as standard. Sole traders welcome.",
    features: [
      "Everything in Individual & Sole Trader",
      "Partner & dependent children included",
...
export const smePlans = [
  {
    id: "family",
    band: "Individual and sole traders",
    employees: "Individual & Sole Traders",
    price: "£100",
    period: "/year",
    sub: "Billed annually · Single practitioner / sole trader",
    covers: "Complete 24/7 private GP healthcare for sole traders & self-employed professionals",
    features: [
      "Unlimited 24/7 GP appointments",
      "Includes partner & dependent children",
      "Phone or video consultations 24/7",
      "Electronic prescriptions & referrals",
      "No underwriting or medical questions",
      "Immediate coverage and support",
    ],
    cta: "Join as Sole Trader",
    featured: false,
    badge: "Sole Trader",
  },
  {
    id: "sme-5",
    band: "Upto 5 employees",
    employees: "Up to 5 employees",
    price: "£140",
    period: "/year",
    sub: "Billed annually on one invoice",
    covers: "Affordable 24/7 private GP healthcare for micro teams & startups",
    features: [
      "Unlimited GP access for up to 5 staff",
      "Employees' partners & children included",
      "Phone or video appointments 24/7",
      "Electronic prescriptions & referrals",
      "No underwriting or health questions",
      "Rapid rollout in days",
    ],
    cta: "Get Cover for Up to 5",
    featured: false,
  },
  {
    id: "sme-10",
    ...
    covers: "Full private GP benefit for small teams and family-run companies",
    features: [
      "Unlimited 24/7 GP access for 6–10 staff",
      "Full family cover included for all staff",
      "Priority same-day GP appointment access",
      "Employer comms pack & member guide",
      "Electronic prescriptions to local pharmacy",
      "Simple one-invoice company billing",
    ],
    cta: "Get Cover for 6–10",
    featured: false,
  },
  {
    id: "sme-15",
    band: "11-15 employees",
    employees: "11–15 employees",
    price: "£225",
    period: "/year",
    sub: "Billed annually · £15.00/employee equivalent",
    covers: "Comprehensive healthcare benefit for growing workforces",
    features: [
      "Unlimited 24/7 GP access for 11–15 staff",
      "Employees' partners & children included",
      "Same-day consultations & expert advice",
      "Specialist open referral letters",
      "No medical exclusions or pre-existing limits",
      "Mid-term joiners covered automatically",
    ],
    cta: "Get Cover for 11–15",
    featured: false,
  },
  {
    id: "sme-20",
    band: "16-20 employees",
    employees: "16–20 employees",
    price: "£275",
    period: "/year",
    sub: "Billed annually · £13.75/employee equivalent",
    covers: "Scalable health cover keeping employee absence to a minimum",
    features: [
      "Unlimited 24/7 appointments for 16–20 staff",
      "Family cover included for every employee",
      "Same-day prescription dispatch",
      "Dedicated company account contact",
      "Reduced absenteeism & prompt treatment",
      "Zero per-call fees ever",
    ],
    cta: "Get Cover for 16–20",
    featured: false,
  },
  {
    id: "sme-25",
    band: "21-25 employees",
    employees: "21–25 employees",
    price: "£325",
    period: "/year",
    sub: "Billed annually · £13.00/employee equivalent",
    covers: "All-inclusive healthcare package for established SME teams",
    features: [
      "Unlimited 24/7 GP care for 21–25 staff",
      "Full family cover included for all employees",
      "Priority video & phone consultations",
      "Onboarding support & HR launch kit",
      "Electronic private sick notes & fit notes",
      "Annual fixed price with no hidden surcharges",
    ],
    cta: "Get Cover for 21–25",
    featured: false,
  },
  {
    id: "sme-50",
    band: "26-50 employees",
    employees: "26–50 employees",
    price: "£450",
    period: "/year",
    sub: "Billed annually · £9.00/employee equivalent",
    covers: "Full corporate cover for larger SMEs looking after staff wellbeing",
    features: [
      "Unlimited 24/7 appointments for up to 50 staff",
      "Full family cover included for all employees",
      "Priority same-day GP appointment access",
      "Dedicated company account manager",
      "Employer comms pack & intranet copy",
      "No retrospective charge for mid-term joiners",
    ],
    cta: "Get Cover for 26–50",
    featured: true,
    badge: "Popular SME Tier",
  },
  {
    id: "enterprise",
    band: "Larger business (POA)",
    employees: "Larger business (50+ employees)",
    price: "POA",
    period: "Price on application",
    sub: "Volume banding & bespoke corporate SLA",
    covers: "Custom enterprise corporate cover for large workforces & organisations",
    features: [
      "Custom headcount pricing & volume discounts",
      "Dedicated clinical governance manager",
      "Custom HR & payroll onboarding",
      "Comprehensive employee launch webinars",
      "Bespoke utilisation & wellbeing analytics",
      "Broker & consultant arrangements supported",
    ],
...
export const businessPage = {
  ...
  pricingTableTitle: "Business cover from £100 a year",
  pricingTableIntro:
    "Banded by headcount, billed annually on one invoice. Full family cover included. No per-call charges.",
  pricingRows: [
    { band: "Individual and sole traders", label: "Individual and sole traders", price: "£100", family: "Included", id: "family" },
    { band: "Upto 5 employees", label: "Up to 5 employees", price: "£140", family: "Included", id: "sme-5" },
    { band: "6-10 employees", label: "6–10 employees", price: "£175", family: "Included", id: "sme-10" },
    { band: "11-15 employees", label: "11–15 employees", price: "£225", family: "Included", id: "sme-15" },
    { band: "16-20 employees", label: "16–20 employees", price: "£275", family: "Included", id: "sme-20" },
    { band: "21-25 employees", label: "21–25 employees", price: "£325", family: "Included", id: "sme-25" },
    { band: "26-50 employees", label: "26–50 employees", price: "£450", family: "Included", id: "sme-50" },
    { band: "Larger business (POA)", label: "Larger business (POA - Price on application)", price: "POA", family: "Included", id: "enterprise" },
  ],
