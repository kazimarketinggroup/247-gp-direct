...
export const smePlans = [
  {
    ...
    covers: "Complete 24/7 private GP healthcare for micro & small teams",
    features: [
      "Unlimited GP appointments for up to 25 staff",
  ...
  },
  {
    ...
    price: "£410",
    period: "/year",
    sub: "Billed annually · £8.20/employee equivalent",
    covers: "Full cover for growing businesses looking after staff wellbeing",
    features: [
  ...
  },
  {
    ...
    price: "£650",
    period: "/year",
    sub: "Billed annually · £6.50/employee equivalent",
    covers: "Comprehensive private GP benefit for medium-sized enterprises",
    features: [
      "Unlimited 24/7 GP access for up to 100 staff",
      "Family cover for all employees included",
      "Anonymised utilisation reporting for HR",
      "Named account manager & priority support",
      "Prescriptions delivered to home or office",
      "Reduced absenteeism & presenteeism",
    ],
    cta: "Enquire for 51–100",
    featured: false,
  },
  {
    band: "101+",
    ...
    price: "Bespoke",
    period: "tailored",
    sub: "Volume banding & bespoke SLA",
    covers: "Custom enterprise corporate cover for large workforces",
    features: [
